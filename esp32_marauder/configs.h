#pragma once
  ...
  //#define DUAL_MINI_C5
  #define FREENOVE_ESP32S3_DISPLAY
  //// END BOARD TARGETS
  ...
  //// HARDWARE NAMES
    ...
    #define HARDWARE_NAME "Freenove ESP32-S3 2.8inch"
  #else
 ...
 //// BOARD FEATURES
  ...
  //// BUTTON DEFINITIONS
    ...
    // New ok pointless con
      ...
      #define HAS_C
  // #define HAS_L, HAS_R, HAS_U, HAS_D are omitted
  ...
  //// SD DEFINITIONS
    ...
    #ifdef FREENOVE_ESP32S3_DISPLAY
      #define SD_CS -1   // no SPI SD, SD_MMC is used (you can adjust later)
    #endif
