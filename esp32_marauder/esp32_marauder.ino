...
void setup()
{
  ...
  // esp_spiram_init() removed in ESP-IDF 5.x - PSRAM is auto-initialized
  ...
  #if defined(HAS_SD) && !defined(HAS_C5_SD) && !defined(FREENOVE_ESP32S3_DISPLAY)
    // Only run SPI SD init for boards that actually have an SPI CS pin
      #if SD_CS != -1
